            ...
            <div v-for="api in apis">
                <div class="card-grid-space">
                    <a class="card" v-if="!api.edit"
                        ...
                        <span class="material-icons update-api" @click="editAPI(api.id)">edit</span>
                        <span class="material-icons delete-api" @click="delAPI(api.id)">delete</span>
                    </a>
                    <a class="card-update" v-if="api.edit">
                        <div>
                            <input type="text" id="updatedApiName" :placeholder="api.apiName" class="api-input">
                            <input type="text" id="updatedApiDomain" :placeholder="api.apiDomain" class="domain-input">
                            <div class="tags">
                                <div class="tag">
                        ...
                        <span class="material-icons cancel-update" @click="editAPI(api.id)">cancel</span>
                    </a>
                </div>
            </div>
            ...
            <div v-if="expanded">
                <div class="card-grid-space">
                    <a class="card-update">
                        ...
                        <span class="material-icons cancel-update" @click="ToggleApi()">cancel</span>
                    </a>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        async updateAPI(api) {
            const updateAPI = {
                apiName: await document.getElementById("updatedApiName").value || api.apiName,
                apiDomain: await document.getElementById("updatedApiDomain").value || api.apiDomain,
                apiType: await document.getElementById("updatedApiType").value || api.apiType
            };
